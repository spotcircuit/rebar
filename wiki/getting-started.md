...
- [[how-it-works/commands]] -- all 29 slash commands including the close-loop harness
- [[how-it-works/three-systems]] -- why the framework uses YAML + memory + skills + wiki
- [[how-it-works/self-learn-loop]] -- per-observation validation; see architecture.md for the per-feature harness
- [[how-it-works/paperclip-integration]] -- autonomous agent orchestration layer
