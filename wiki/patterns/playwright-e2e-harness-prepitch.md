...
- [[patterns/streaming-tts-mediasource]] — voice pipeline exercised by voice-convai and agent-vs-agent-voice specs
- [[patterns/websocket-progress-pattern]] — WebSocket backend tested by backend-ws spec
- [[patterns/pre-release-checklist]] — E2E gate is part of the release checklist
