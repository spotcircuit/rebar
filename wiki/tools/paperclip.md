...
#tool #paperclip #agents #orchestration
...
Source: rebar codebase — system/paperclip.yaml, scripts/paperclip-sync.sh, tools/paperclip/expertise.yaml. Living reference.
